...
class schism_view:
    ...
    def schism_plot(self,fmt=0):
        ...
        p.bm=blit_manager(p.hf,[p.ht,*p.hp,*p.hg,*p.hv]); p.bm.update(); self.update_panel('it',p)
    ...
    def init_window(self):
        ...
        fm3=ttk.Frame(master=fm); fm3.grid(row=1,column=0,sticky='W')
