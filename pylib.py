...
if not set(Libs).issubset(set(sys.modules.keys())):
   ...
   from mylib import (ntype,xtick,get_xtick,close_data_loop,datenum,quickdatenum, #type,
        add_basemap,get_basemap,get_INFO,loadz,zdata,savez,addz,find_cs,npz2mat,read_mat,sort_all,
        ...
        nargout,pause,isnumber,ncfile,urlsave,add_var,compute_dem_contour,copyfile,
        copydir,torch_device,n2t,t2n,gif_to_avi)
