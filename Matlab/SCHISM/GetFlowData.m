function C=GetFlowData(StaName,StartT,EndT,flag)
...
%----Database
DataBase='D:\Work\Database\River_Flow\Data.mat\'; %UMaine Desktop
% DataBase='E:\Work\Database\River_Flow_ChesBay\Data.mat\';  %UMaine_Desktop_ChesBay
% DataBase1='W:\Database\River_Flow\Data.mat\';
if ~exist(DataBase)
    DataBase=DataBase1;
end
