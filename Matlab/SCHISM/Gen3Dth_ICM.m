%function Gen3Dth_ICM()
%Generate 3D boundary condition ICM_3D.th
...
%--read grid info
[ne,np,lx,ly,dp,i34,elnode,bndinfo]=read_schism_hgrid('hgrid.gr3',1);
nodei=bndinfo.iobn{1};
[zcor,nvrt]=read_schism_vgrid('vgrid.in',np,nodei,dp(nodei),0,0.1,1);
